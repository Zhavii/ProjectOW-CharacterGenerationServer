...
const createAvatarThumbnail = async (user, hash, type, res) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let hair = await getImage(user.customization.hair)
            let beard = await getImage(user.customization.beard)
            let eyes = await getImage(user.customization.eyes)
            let eyebrows = await getImage(user.customization.eyebrows)
